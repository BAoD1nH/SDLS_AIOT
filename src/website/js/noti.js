...
// Send the Push Notification to the deviceID - PushSafer - when the DOOR LOCK opened successfully
// This is used to notify the user that their door lock has been opened
